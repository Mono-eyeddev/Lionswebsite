...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT id, name, email, subject, message FROM contact WHERE id = $id";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<form class='updform' action='updateii_process.php' method='POST'>";
        echo "<input type='hidden' name='id' value='".$row["id"]."'>";
        echo "Name: <input type='text' name='name' value='".$row['name']."'><br>";
        echo "Email: <input type='text' name='email' value='".$row['email']."'><br>";
        echo "Subject: <input type='text' name='subject' value='".$row['subject']."'><br>";
        echo "Message: <textarea name='message'>".$row['message']."</textarea><br>";
